...
CREATE TABLE IF NOT EXISTS posts (
    ...
    post_modified_time TIMESTAMPTZ NOT NULL,
        -- Date on which post was created / edited, auto generated by db
    post_like_count INTEGER DEFAULT 0 NOT NULL,
    post_comment_count INTEGER DEFAULT 0 NOT NULL,
...
CREATE TABLE IF NOT EXISTS comments (
    ...
    comment_modified_time TIMESTAMPTZ NOT NULL,
...
CREATE TABLE IF NOT EXISTS post_likes (
    ...
    CONSTRAINT fk_like_post_id FOREIGN KEY (post_id) REFERENCES posts(post_id),
